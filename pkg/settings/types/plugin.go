...
type Plugin struct {
	...
	Type   PluginType `xorm:"TINYINT(2) not null comment('插件类型：1 IP访问，2 签名，3 JWT，4 跨域访问，5 缓存，6 错误码映射，7 流量控制，8 OAuth2，9 熔断，10 crycx auth app，11 crycx auth h5，12 crycx real name，13 crycx view count，14 身份认证')"`
